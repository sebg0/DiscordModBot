...
exports.run = async (client, message, args) => {
  ...
  if (message.member.roles.highest.position <= message.guild.members.cache.get(person.id).roles.highest.position) return message.channel.send("You can't unmute that user because your highest role is not above their highest role.");
